(function () {
  ...
  const COLUMN_MAP = {
    analysis_type: ["analysis_type", "analysis type", "analysis_type_label"],
    category_antecedent: ["category_antecedent", "antecedent category", "category_antecedent"],
    category_consequent: ["category_consequent", "consequent category", "category_consequent"],
    antecedent_name: ["antecedent_name", "antecedent", "antecedent name", "antecedent_name"],
    consequent_name: ["consequent_name", "consequent", "consequent name", "consequent_name"],
    pair_count: ["pair_count", "pair count", "pair_count"],
    support: ["support"],
    confidence: ["confidence"],
    lift: ["lift"],
    leverage: ["leverage"],
    conviction: ["conviction"],
    itemset_size: ["itemset_size", "itemset size", "itemset", "itemset_size"],
    opportunity_score: ["opportunity_score", "opportunity score", "opportunity_score"],
    rule_label: ["rule_label", "rule label", "rule", "rule_label"],
  ...
  function renderTable(records, sortBy) {
    ...
    document.getElementById("tableBody").innerHTML = topRows.map(function (row, index) {
      return "<tr>" +
        ...
        '<td class="num">' + (row.conviction === null ? "-" : formatNumber(row.conviction, 2)) + "</td>" +
